...
English documentation: [README.md](README-completo.md).

## Cómo funciona

![Cómo funciona: el agente dice hecho, el hook Stop llama a rompelo, rompelo lee el contrato y lo compara con la evidencia; si falta algo bloquea con motivos, si todo se cumple hay silencio](img/es/como-funciona.png)

## El problema del que parte

![Gráfico de barras de 36 incidentes reales por clase: instrumento ciego 16, señal al parar 6, contexto 4, mixto 3, al ejecutar la herramienta 3, auditoría 2, producción 2](img/es/corpus.png)
...
![Salida real del hook: la tarea no puede darse por terminada; dos checks sin ejecutar; junta sin cruce real](img/es/bloqueo.png)
...
![Tres pasos: verde de partida, mutación confirmada que lo pone en rojo, deshecha y verde otra vez](img/es/rojo-primero.png)
...
del cierre. [Configuración y límites](control-positivo.md).
