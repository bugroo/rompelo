...
| 0036 | I | Control negativo real por agente con fallos conocidos: contar resultados y procedencia; una distribución sin fallos solo es indicio, no prueba por sí sola. |
...
- **0036** · Codex omite el estado estructurado en el hook de Bash; interpretar stdout como código producía falsos éxitos (`Reproducción original 05-09: 226 comandos sin fallos registrados y un ls roto como 0. Diagnóstico corregido el 16-09: código oficial y sesiones nativas Codex 0.154.0 prueban que el hook entrega stdout independientemente de text(r.output); el rollout contiene CommandExecution con exit_code. Tres salidas engañosas reproducían falsos ceros.`)
